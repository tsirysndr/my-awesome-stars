...
- [paritytech/xcm-format](https://github.com/paritytech/xcm-format) - Polkadot Cross Consensus-system Message format.
...
- [romankoblov/prettydiff](https://github.com/romankoblov/prettydiff) - Side-by-side diff for two files
...
- [paritytech/subxt](https://github.com/paritytech/subxt) - Submit extrinsics (transactions) to a substrate node via RPC
